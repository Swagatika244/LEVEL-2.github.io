...
standFire = createSprite(stand.x, stand.y-30, 265, 60);
standFire.addImage(stepFireImage);
standFire.scale = 0.1;
standFire.depth =stand.depth +1;
standFire.visible = false;
...
if(weapons[6].x === width - 50){
  ...
  if(deathFeedbacks[6].visible){
    window.open("https://swagatika244.github.io/winningPage.github.io/");
    close();
  }
...
function gameEnd2(){ 
  ...
  shootFireGroup2 = new Group();
      ...
      restartBtn.mouseClicked(()=>{
        click.play();
        window.open('https://swagatika244.github.io/c46/', '_parent');
      });   
      ...
      copyInput = createInput('https://swagatika244.github.io/c46/');
